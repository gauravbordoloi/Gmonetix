...
public class Const {
    ...
    public static final String url = "http://gmonetix.com/wp-json/wp/v2/posts/?filter[category_name]=android&per_page=50&fields=id,date,link,title,better_featured_image";
